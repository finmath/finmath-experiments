...
public interface ModelFactory {
	...
	/**
	 * Create a model with a discount curve using the given zero rates in the discount curve.
	 *
	 ...
	 */
	AnalyticModel getModel(double[] maturities, double[] zeroRates, String discountCurveName);
	 ...
	 */
	AnalyticModel getModelWithShift(double[] maturities, double[] zeroRates, String discountCurveName, int bucket, double shift);
