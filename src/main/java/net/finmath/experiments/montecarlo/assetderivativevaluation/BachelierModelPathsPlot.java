...
/**
 * Simple program plotting paths of a Bachelier model.
 * 
 * @author Christian Fries
 */
public class BachelierModelPathsPlot {

	public static void main(String[] args) {
		double modelInitialValue = 100.0;	// S(0)
		double modelRiskFreeRate = 0.05; 	// r
		double modelVolatility = 20;		// σ
		...
		// Create a model
		var model = new BachelierModel(modelInitialValue, modelRiskFreeRate, modelVolatility);
		...
		plot.setTitle("Bachelier model paths").setXAxisLabel("time").setYAxisLabel("value");
		plot.show();
	}
}
